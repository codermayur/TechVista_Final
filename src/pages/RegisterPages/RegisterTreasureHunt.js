    ...
    <div className="text-white h-screen w-full relative bg-[#030f0a] overflow-hidden flex flex-col">
      ...
      <div className="flex-1 w-full h-full overflow-y-auto flex flex-col relative pl-16 md:pl-24 pr-16 md:pr-24 no-scrollbar">
        ...
        <header className="py-10 flex justify-center items-center z-40 w-full relative">
           <h1 className="font-orbitron tracking-[0.3em] text-lg font-black uppercase text-[#39ff14]">Registration: Treasure Hunt</h1>
        </header>
        ...
        <main className="z-10 w-full max-w-2xl mx-auto bg-black/40 backdrop-blur-xl p-8 rounded-xl border border-white/10 shadow-2xl mb-20 fade-in-up">
            <div className="space-y-6">
                <p className="text-gray-300 text-center font-orbitron text-sm">Solve cryptic clues and race against time across the campus.</p>
                <div className="border border-white/5 p-10 text-center rounded-lg italic text-gray-400">Treasure Hunt Form...</div>
                <button className="w-full font-orbitron text-sm font-bold uppercase text-[#030f0a] py-3 rounded-md sign-in-btn">Start Hunt</button>
            </div>
        </main>
      </div>
    </div>
...
export default RegisterTreasureHunt;