...
const AdForge = () => {
  ...
  const adForgeFields = [
    { id: 'teamName', label: 'Team Name (Optional if Solo)', placeholder: 'Enter your team name', required: false, },
    { id: 'participant1', label: 'Participant 1 (Lead)', placeholder: 'Full name', required: true },
    { id: 'email', label: 'Contact Email', type: 'email', placeholder: 'lead@example.com', required: true },
    { id: 'phone', label: 'Phone Number', type: 'tel', placeholder: '+91 00000 00000', required: true },
    { id: 'college', label: 'College Name', placeholder: 'Enter your institute', required: true},
    { id: 'participant2', label: 'Participant 2 (Optional)', placeholder: 'Duo partner full name', required: false },
    { id: 'aiTools', label: 'Anticipated AI Tools', placeholder: 'e.g. Canva, Sora, Midjourney', required: true },
  ...
  const handleRegistration = (formData) => {
    console.log("Ad-O-Forge Marketing Protocol Initialized:", formData);
  };
        ...
        <main className="z-10 py-20 flex flex-col items-center">
            <div className="max-w-3xl w-full mb-10 text-center fade-in-up">
              ...
              <div className="flex justify-center flex-wrap gap-4 mt-4 font-orbitron text-[10px] tracking-[0.3em] text-[#00ffd5] opacity-80">
                ...
                <span>SIZE: SOLO / DUO</span>
              </div>
              
              <div className="mt-8 bg-black/30 backdrop-blur-md border border-white/5 p-6 rounded-lg text-left">
                <p className="text-gray-300 font-light leading-relaxed mb-6">
                  Bring fictional products to life using modern marketing strategies, AI-generated video ads, and promotional posters.
                </p>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-4 border-t border-white/10 pt-6">
                  <div className="space-y-2 text-[9px] uppercase tracking-widest text-[#39ff14]/70">
                    <p>• One machine per team</p>
                    <p>• Must use own AI tools</p>
                    <p>• No external collaboration</p>
                    <p>• Pitches before judges</p>
                  </div>
            ...
            <RegistrationForm 
              title="Creative Marketing Entry Terminal" 
              fields={adForgeFields} 
