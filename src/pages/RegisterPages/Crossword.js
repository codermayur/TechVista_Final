...
const Crossword = () => {
  ...
  const crosswordFields = [
    ...
    { id: 'phone', label: 'WhatsApp Number', type: 'tel', placeholder: '+91 00000 00000', required: true },
    { id: 'college', label: 'College Name', placeholder: 'Enter your institute name', required: true },
    { id: 'expertise', label: 'Primary Language', placeholder: 'e.g. C++, Java, Python, JavaScript', required: true },
  ...
  const handleRegistration = (formData) => {
    console.log("Crossword Protocol Initialized:", formData);
  };
        ...
        <main className="z-10 py-20 flex flex-col items-center">
            <div className="max-w-3xl w-full mb-10 text-center fade-in-up">
              ...
              <div className="flex justify-center flex-wrap gap-4 mt-4 font-orbitron text-[10px] tracking-[0.3em] text-[#00ffd5] opacity-80">
                <span>VENUE: SEMINAR HALL 1</span>
                <span>DATE: 27TH FEB (DAY 1)</span>
                <span>TYPE: LOGIC CHALLENGE</span>
              </div>
              
              <div className="mt-8 bg-black/30 backdrop-blur-md border border-white/5 p-6 rounded-lg text-left">
                <p className="text-gray-300 font-light leading-relaxed mb-6">
                  Challenge your syntax knowledge and logic speed. Solve programming-themed crosswords, predict complex outputs, and identify code structures under the clock.
                </p>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-4 border-t border-white/10 pt-6">
                  <div className="space-y-2 text-[9px] uppercase tracking-widest text-[#39ff14]/70">
                    <p>• Format: Solo Participation</p>
                    <p>• Predict Output & Debug</p>
                    <p>• Programming Crossword Grid</p>
                    <p>• Speed & Accuracy Scoring</p>
                  </div>
            ...
            <RegistrationForm 
              title="Logic Protocol Entry Terminal" 
              fields={crosswordFields} 
