...
const Footer = ({ activeNav, setActiveNav, onHomeClick }) => (
    <footer className="mobile-footer-wrapper">
        <div className="mobile-footer-content">
            ...
            <a href="https://www.instagram.com/techvista_vsit/" target='_blank' rel="noopener noreferrer" className="social-item"><div className="w-6 h-6"><InstaIcon /></div><span>Insta</span></a>
            <a href="https://www.linkedin.com/school/vsit-mumbai/posts/?feedView=all" target='_blank' rel="noopener noreferrer" className="social-item"><div className="w-6 h-6"><LinkedInIcon /></div><span>LinkedIn</span></a>
        </div>
    </footer>
);
